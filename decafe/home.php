...
<div class="col-lg-9 mt-2">
    ...
    <div class="card mt-4 border-0 bg-light">
        <div class="card-body text-center">
            ...
            <p class="card-text"> Aplikasi Pemesanan Makanan Dan Minuman Yang Mudah Dan Praktis. Mari Mencoba Aplikasi Pemesanan ini</p>
                ...
                new Chart(ctx, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            borderWidth: 1,
                            backgroundColor :[
                                'rgba(245, 39, 114, 0.61)',
                                'rgba(74, 169, 166, 0.61)',
                                'rgba(233, 236, 12, 0.88)',
                                'rgba(14, 236, 12, 0.88)',
                                'rgba(50, 1, 42, 0.88)',
                                'rgba(229, 136, 12, 0.88)',
                            ]
                        }]
                    },
                    options: {
